   ...
   return(
    <HomeLayout>
     <div className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text">
        ...
        {lecture && lecture.length > 0 && <div className="flex justify-center gap-10 w-full">
         <div className="space-y-5 w-[28rem] o-2 rounded-lg shadow-[0_0_10px_black]">
         <video src={lecture && lecture[currentVideo]?.lecture?.secure_url } className="object-fill rounded-tl-lg rounded-tr-lg w-full" controls disablePictureInPicture muted controlsList="nodownload"></video>
         <div>
           <h1>
         ...
         <ul className="w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black] space-y-4">
            ...
            {lecture && lecture.map((lecture,idx) =>{ return (
