                    ...
                    <div className=" relative w-80 h-[26rem] flex flex-col justify-center items-center shadow-[0_0_10px_black] rounded-lg">
                      ...
                      <div className="px-4 flex flex-col items-center justify-center space-y-2">
                        <div className="text-center space-y-1"> 
                            <h2 className="text-lg font-semibold">Welcom to the pro bundle</h2>
                      ...
                      <Link to='/' className="bg-green-500 hover:bg-green-600 transition-all ease-in-out  duration-300 absolute bottom-0 py-2 w-full text-lg font-semibold text-center rounded-br-lg rounded-bl-lg">
                        <button>
                          Go to dashboard
                        </button>
                      </Link>
